 ...
 */
class pluzDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $instance->setEntityNamespaces(array('BlogBundle' => 'Application\\BlogBundle\\Entities'));
    ...
    protected function getDoctrine_Orm_MetadataDriverService()
    {
        ...
        $instance->addDriver($this->getDoctrine_Orm_MetadataDriver_AnnotationService(), 'Application\\BlogBundle\\Entities');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $instance = call_user_func(array('Doctrine\\DBAL\\DriverManager', 'getConnection'), array('driverClass' => 'Doctrine\\DBAL\\Driver\\PDOMySql\\Driver', 'driverOptions' => array(), 'dbname' => 'symfony2blog', 'host' => 'localhost', 'user' => 'root', 'password' => 'mysql'), $this->getDoctrine_Dbal_DefaultConnection_ConfigurationService(), $this->getDoctrine_Dbal_DefaultConnection_EventManagerService());
  ...
  array (
    ...
    {
        return array(
            'kernel.root_dir' => '/www/symfony2blog/pluz',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'pluz',
            'kernel.cache_dir' => '/www/symfony2blog/pluz/cache/dev',
            'kernel.logs_dir' => '/www/symfony2blog/pluz/logs',
            'kernel.bundle_dirs' => array(
                'Application' => '/www/symfony2blog/pluz/../src/Application',
                'Bundle' => '/www/symfony2blog/pluz/../src/Bundle',
                'Symfony\\Framework' => '/www/symfony2blog/pluz/../src/vendor/symfony/src/Symfony/Framework',
            ),
            ...
            'templating.loader.filesystem.path' => array(
                0 => '/www/symfony2blog/pluz/views/%bundle%/%controller%/%name%%format%.%renderer%',
                1 => '/www/symfony2blog/pluz/../src/Application/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
                2 => '/www/symfony2blog/pluz/../src/Bundle/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
                3 => '/www/symfony2blog/pluz/../src/vendor/symfony/src/Symfony/Framework/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
            ),
            'doctrine.orm.metadata_driver.mapping_dirs' => array(

            ),
            'doctrine.orm.entity_dirs' => array(
                0 => '/www/symfony2blog/src/Application/BlogBundle/Entities',
            ),
            ...
            'profiler.storage.file' => '/www/symfony2blog/pluz/cache/dev/profiler.db',
...
',
            'zend.logger.path' => '/www/symfony2blog/pluz/logs/dev.log',
        );
    }
}
